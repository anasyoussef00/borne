...
import IPNPNumberForm from '@/components/renewal/forms/IPNPNumber/IPNPNumberForm.vue';
...
<template>
  ...
  >
    ...
    <section class="flex flex-col gap-y-8 w-10/12 mx-auto">
      <RenewalForm
        title-ext="Numéro de Police et numéro de sociétaire - رقم الوثيقة ورقم العضو"
        :steps="steps"
        img-src="/src/assets/imgs/examples/PNMNM.jpg"
      >
